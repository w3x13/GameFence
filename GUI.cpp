...
#define UI_CURSORFILL       Color(119, 213, 41, 255)
...
void CGUI::Update()
{
	if (Options::Menu.ColorsTab.watermark.GetState())
	{
		Render::Clear(1470, 13, 280, 18, Color(30, 206, 6, 170));
		Render::Text(1473, 15, Color(255, 255, 255, 255), Render::Fonts::supremacy, ("GameFence |"));
		Render::Textf(1542, 15, Color(255, 255, 255, 255), Render::Fonts::supremacy, ("%s | PUBLIC BUILD | 14.2.2019"), GetTimeString().c_str());
	}
...
void CGUI::SaveWindowState(CWindow* window, std::string Filename)
{
	...
	tinyxml2::XMLElement *Root = Doc.NewElement("GameFence");
