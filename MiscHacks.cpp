...
void CMiscHacks::Move(CUserCmd *pCmd, bool &bSendPacket)
{
	...
	if (pWeapon != nullptr)
	{
		if (Options::Menu.MiscTab.minimal_walk.GetState())
		{
		...
		{
			Options::Menu.RageBotTab.AccuracyHitchance.SetValue(100);
			Options::Menu.RageBotTab.AccuracyMinimumDamage.SetValue(100);
		}
	}
...
void CMiscHacks::PostProcces()
{
	...
	if (Options::Menu.ColorsTab.Ayyware.GetState())
	{
